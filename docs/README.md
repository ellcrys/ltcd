...
* Install the MSI available at: https://github.com/ellcrys/ltcd/releases
...
$ git clone https://github.com/ellcrys/ltcd $GOPATH/src/github.com/ellcrys/ltcd
$ cd $GOPATH/src/github.com/ellcrys/ltcd
...
ltcd has a number of [configuration](http://godoc.org/github.com/ellcrys/ltcd)
...
* [Using bootstrap.dat](https://github.com/ellcrys/ltcd/tree/master/docs/using_bootstrap_dat.md)

<a name="NetworkConfig" />

**3.1.2 Network Configuration**

* [What Ports Are Used by Default?](https://github.com/ellcrys/ltcd/tree/master/docs/default_ports.md)
* [How To Listen on Specific Interfaces](https://github.com/ellcrys/ltcd/tree/master/docs/configure_peer_server_listen_interfaces.md)
* [How To Configure RPC Server to Listen on Specific Interfaces](https://github.com/ellcrys/ltcd/tree/master/docs/configure_rpc_server_listen_interfaces.md)
* [Configuring ltcd with Tor](https://github.com/ellcrys/ltcd/tree/master/docs/configuring_tor.md)
...
* [Code Contribution Guidelines](https://github.com/ellcrys/ltcd/tree/master/docs/code_contribution_guidelines.md)

<a name="JSONRPCReference" />

* [JSON-RPC Reference](https://github.com/ellcrys/ltcd/tree/master/docs/json_rpc_api.md)
    * [RPC Examples](https://github.com/ellcrys/ltcd/tree/master/docs/json_rpc_api.md#ExampleCode)

<a name="GoPackages" />

* The ltcsuite Litecoin-related Go Packages:
    * [btcrpcclient](https://github.com/ellcrys/ltcd/tree/master/rpcclient) - Implements a
      robust and easy to use Websocket-enabled Bitcoin JSON-RPC client
    * [btcjson](https://github.com/ellcrys/ltcd/tree/master/btcjson) - Provides an extensive API
      for the underlying JSON-RPC command and return values
    * [wire](https://github.com/ellcrys/ltcd/tree/master/wire) - Implements the
      Bitcoin wire protocol
    * [peer](https://github.com/ellcrys/ltcd/tree/master/peer) -
      Provides a common base for creating and managing Bitcoin network peers.
    * [blockchain](https://github.com/ellcrys/ltcd/tree/master/blockchain) -
      Implements Bitcoin block handling and chain selection rules
    * [blockchain/fullblocktests](https://github.com/ellcrys/ltcd/tree/master/blockchain/fullblocktests) -
      Provides a set of block tests for testing the consensus validation rules
    * [txscript](https://github.com/ellcrys/ltcd/tree/master/txscript) -
      Implements the Bitcoin transaction scripting language
    * [btcec](https://github.com/ellcrys/ltcd/tree/master/btcec) - Implements
      support for the elliptic curve cryptographic functions needed for the
      Bitcoin scripts
    * [database](https://github.com/ellcrys/ltcd/tree/master/database) -
      Provides a database interface for the Bitcoin block chain
    * [mempool](https://github.com/ellcrys/ltcd/tree/master/mempool) -
      Package mempool provides a policy-enforced pool of unmined bitcoin
      transactions.
    * [btcutil](https://github.com/ellcrys/ltcutil) - Provides Bitcoin-specific
      convenience functions and types
    * [chainhash](https://github.com/ellcrys/ltcd/tree/master/chaincfg/chainhash) -
      Provides a generic hash type and associated functions that allows the
      specific hash algorithm to be abstracted.
    * [connmgr](https://github.com/ellcrys/ltcd/tree/master/connmgr) -
