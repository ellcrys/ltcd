...
(http://godoc.org/github.com/ellcrys/ltcd/peer)
...
```bash
$ go get -u github.com/ellcrys/ltcd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/ellcrys/ltcd/peer#example-package--NewOutboundPeer)  
